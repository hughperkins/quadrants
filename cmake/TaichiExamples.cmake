...
add_executable(cpp_examples_run_snode_init_builder "cpp_examples/run_snode_init_builder.cpp")
target_link_libraries(cpp_examples_run_snode_init_builder PRIVATE taichi_core)
target_include_directories(cpp_examples_run_snode_init_builder
  PRIVATE
    ${PROJECT_SOURCE_DIR}
...
add_executable(cpp_examples_run_snode_ret_builder "cpp_examples/run_snode_ret_builder.cpp")
target_link_libraries(cpp_examples_run_snode_ret_builder PRIVATE taichi_core)
target_include_directories(cpp_examples_run_snode_ret_builder
  PRIVATE
    ${PROJECT_SOURCE_DIR}
    ${PROJECT_SOURCE_DIR}/external/spdlog/include
    ${PROJECT_SOURCE_DIR}/external/eigen
...
add_executable(cpp_examples_run_snode_ret_mine "cpp_examples/run_snode_ret_mine.cpp")
target_link_libraries(cpp_examples_run_snode_ret_mine PRIVATE taichi_core)
target_include_directories(cpp_examples_run_snode_ret_mine
  PRIVATE
    ${PROJECT_SOURCE_DIR}
    ${PROJECT_SOURCE_DIR}/external/spdlog/include
    ${PROJECT_SOURCE_DIR}/external/eigen
