...
sifakis_svd_export(ASTBuilder *ast_builder, const Expr &mat, int num_iters) {
  ...
  auto Var = [ast_builder](const quadrants::lang::Expr &x) { return ast_builder->make_var(x); };
  ...
  ast_builder->insert_assignment(Scosine_pi_over_eight, Expr(Cosine_Pi_Over_Eight));
  ...
  ast_builder->insert_for(Expr(0), Expr(num_iters), [&](Expr sweep) {
    ...
    ast_builder->insert_assignment(
        Stmp1, bit_cast<Tf>(expr_select(Stmp2 >= Stiny_number, Expr(Ti(int32(0xffffffff))), Expr(Ti(0)))));
    ...
    ast_builder->insert_assignment(Stmp2, svd_bitwise_and<Tf, Ti>(Expr(~bit_cast<Ti>(Stmp1)), Sone));
    ...
    ast_builder->insert_assignment(Stmp1,
                                   bit_cast<Tf>(expr_select(Stmp2 <= Stmp1, Expr(Ti(int32(0xffffffff))), Expr(Ti(0)))));
    ast_builder->insert_assignment(Stmp2, svd_bitwise_and<Tf, Ti>(Ssine_pi_over_eight, Stmp1));
    ast_builder->insert_assignment(Ssh, svd_bitwise_and<Tf, Ti>(Expr(~bit_cast<Ti>(Stmp1)), Ssh));
    ast_builder->insert_assignment(Ssh, svd_bitwise_or<Tf, Ti>(Ssh, Stmp2));
    ast_builder->insert_assignment(Stmp2, svd_bitwise_and<Tf, Ti>(Scosine_pi_over_eight, Stmp1));
    ast_builder->insert_assignment(Sch, svd_bitwise_and<Tf, Ti>(Expr(~bit_cast<Ti>(Stmp1)), Sch));
    ast_builder->insert_assignment(Sch, svd_bitwise_or<Tf, Ti>(Sch, Stmp2));
    ast_builder->insert_assignment(Stmp1, Ssh * Ssh);
    ast_builder->insert_assignment(Stmp2, Sch * Sch);
  ...
  ast_builder->insert_assignment(Stmp3, Stmp3 + Stmp4);
  ast_builder->insert_assignment(Stmp4,
                                 bit_cast<Tf>(expr_select(Stmp1 < Stmp2, Expr(Ti(int32(0xffffffff))), Expr(Ti(0)))));
  ...
  ast_builder->insert_assignment(Stmp4,
                                 bit_cast<Tf>(expr_select(Stmp1 < Stmp3, Expr(Ti(int32(0xffffffff))), Expr(Ti(0)))));
  ...
  ast_builder->insert_assignment(Stmp4,
                                 bit_cast<Tf>(expr_select(Stmp2 < Stmp3, Expr(Ti(int32(0xffffffff))), Expr(Ti(0)))));
  ...
  ast_builder->insert_assignment(
      Ssh, bit_cast<Tf>(expr_select(Ssh >= Ssmall_number, Expr(Ti(int32(0xffffffff))), Expr(Ti(0)))));
  ...
  ast_builder->insert_assignment(Stmp5,
                                 bit_cast<Tf>(expr_select(Sa11 >= Stmp5, Expr(Ti(int32(0xffffffff))), Expr(Ti(0)))));
  ...
  ast_builder->insert_assignment(Stmp1, svd_bitwise_and<Tf, Ti>(Expr(~bit_cast<Ti>(Stmp5)), Ssh));
  ast_builder->insert_assignment(Stmp2, svd_bitwise_and<Tf, Ti>(Expr(~bit_cast<Ti>(Stmp5)), Sch));
  ...
  ast_builder->insert_assignment(Sch, max(Sch, Ssmall_number));
  ast_builder->insert_assignment(Stmp5,
                                 bit_cast<Tf>(expr_select(Sa22 >= Stmp5, Expr(Ti(int32(0xffffffff))), Expr(Ti(0)))));
  ast_builder->insert_assignment(Stmp1, Sch * Sch);
  ast_builder->insert_assignment(Stmp2, Ssh * Ssh);
  ast_builder->insert_assignment(Stmp2, Stmp1 + Stmp2);
  ast_builder->insert_assignment(Stmp1, rsqrt(Stmp2));
  ...
  ast_builder->insert_assignment(Su33, Su33 - Stmp1);
  return std::make_tuple(Su11, Su12, Su13, Su21, Su22, Su23, Su31, Su32, Su33, Sv11, Sv12, Sv13, Sv21, Sv22, Sv23, Sv31,
                         Sv32, Sv33, Sa11, Sa22, Sa33);
}
